...
class MainActivity2 : AppCompatActivity(), android.view.View.OnClickListener {
    ...
    private  var player1= ""
    private  var player2= ""
    private lateinit var kushi1:TextView
    private lateinit var kushi2:TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var faq1 = findViewById<TextView>(R.id.faq1)
        var faq2 =findViewById<TextView>(R.id.faq2)
        faq1.text="$pl1"
        faq2.text="$pl2"
        ...
        kushi1=findViewById(R.id.kushi1)
        kushi2=findViewById(R.id.kushi2)
    ...
    private  fun check(){
        ...
        if (winner>0){
            ...
            kushi1.text=uewkushi1.toString()
            kushi2.text=uewkushi2.toString()
            pirvelivar.clear()
            meorevar.clear()
